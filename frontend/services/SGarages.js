...
function attachEvents(){
  ...
  document.querySelectorAll(".reserve-btn").forEach(btn=>{
    btn.addEventListener("click",()=>{
      ...
      const garageName=card.querySelector("h3").textContent;
      ...
      const speciality = card.querySelector(".garage-info p")?.textContent.split("·")[0]?.trim() || "";
      const city = card.querySelector(".garage-info p")?.textContent.split("·")[1]?.trim() || "";
